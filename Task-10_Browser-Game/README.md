<!-- 1. В корневой папке проекта с игрой создать файл README.md на языке разметки Markdown. Подробнее о синтаксисе этого языка можно почитать здесь или здесь.
